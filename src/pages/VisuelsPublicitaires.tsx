  ...
  return (
    <FeatureLandingPage
      ...
      hero={{
        ...
        subheading:
          "Ecomfy génère vos publicités Facebook, Instagram, TikTok et WhatsApp avec une intelligence artificielle entraînée pour le marché africain. Aucune compétence en design requise.",
      ...
      faq={[
        { question: "Combien coûte la création d'un visuel ?", answer: "Ecomfy propose un essai gratuit avec plusieurs générations offertes. Ensuite, des packs de crédits en FCFA (à partir de 1 000 FCFA) sont disponibles sans engagement." },
