...
export default function VisuelsPublicitaires() {
  return (
    <FeatureLandingPage
      ...
      faq={[
        { question: "Combien coûte la création d'un visuel ?", answer: "VisualPro propose un essai gratuit avec plusieurs générations offertes. Ensuite, des packs de crédits en FCFA (à partir de 1 000 FCFA) sont disponibles sans engagement." },
