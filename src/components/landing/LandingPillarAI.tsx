                  ...
                  <div className="bg-white/5 border border-white/10 rounded-2xl rounded-tl-sm p-4 w-full max-w-[90%]">
                    ...
                    <div className="w-full h-40 bg-slate-800/50 rounded-lg relative overflow-hidden flex items-center justify-center">
                      <video 
                        ...
                        muted 
                        playsInline
                        poster="https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&q=80&w=400&h=300"
                      >
                        ...
                        <img src="https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&q=80&w=400&h=300" alt="Video fallback" className="w-full h-full object-cover" />
                      </video>
