        ...
        >
          ...
          <div className="flex-1 w-full flex items-center justify-center py-12 lg:py-0">
            <div className="relative w-[85%] max-w-[340px] lg:max-w-[420px]">
              {/* Background Blob */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-emerald-100 rounded-full filter blur-3xl opacity-50"></div>
              ...
              <div className="relative w-full bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden z-10 animate-float">
                ...
                <div className="p-4 grid grid-cols-2 gap-4 bg-white">
                  <div className="border border-slate-100 rounded-xl p-4 shadow-sm relative overflow-hidden">
                    ...
                    <p className="text-lg md:text-xl font-black text-slate-900 mb-2 whitespace-nowrap">3 450 000 F</p>
                  ...
                  <div className="border border-slate-100 rounded-xl p-4 shadow-sm relative overflow-hidden">
                    ...
                    <p className="text-lg md:text-xl font-black text-slate-900 mb-2 whitespace-nowrap">28 500 F</p>
                    <div className="flex items-center gap-1 text-[10px] font-bold text-emerald-600 bg-emerald-50 w-max px-2 py-0.5 rounded">
              ...
              <div className="absolute -left-6 md:-left-10 bottom-8 md:bottom-12 bg-slate-900 p-4 rounded-xl shadow-xl border border-slate-800 z-20 w-36 md:w-40 animate-float text-white">
                <p className="text-xs text-slate-400 font-semibold mb-1">Marge Nette</p>
                <p className="text-xl md:text-2xl font-black text-white">42%</p>
              ...
              <div className="absolute -right-6 md:-right-10 top-8 md:top-12 bg-white p-3 rounded-xl shadow-xl border border-slate-100 z-20 flex items-center gap-3 animate-float-slow">
                <div className="w-8 h-8 md:w-10 md:h-10 bg-orange-100 rounded-lg flex justify-center items-center shrink-0">
                  <span className="text-orange-600 font-bold text-sm">🏆</span>
                </div>
                <div>
                  <p className="text-[10px] md:text-xs text-slate-500 font-bold">Top Produit</p>
                  <p className="text-xs md:text-sm font-bold text-slate-900">Kit Beauté Pro</p>
                  <p className="text-[10px] md:text-xs text-emerald-600 font-semibold">124 ventes</p>
                </div>
              </div>
            </div>
          </div>
