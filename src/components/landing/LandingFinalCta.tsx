...
export function LandingFinalCta() {
  ...
  return (
    <section className="py-24 md:py-32 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#E3F1EC] rounded-full mix-blend-multiply filter blur-[100px] opacity-60 translate-x-1/3 -translate-y-1/3 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-orange-50 rounded-full mix-blend-multiply filter blur-[100px] opacity-60 -translate-x-1/3 translate-y-1/3 pointer-events-none"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {/* Inner subtle glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-32 bg-[#0E7C66] rounded-[100%] filter blur-[80px] opacity-40"></div>
