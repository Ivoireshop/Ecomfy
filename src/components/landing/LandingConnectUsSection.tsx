  ...
  return (
    <section id="connectus" className="relative py-12 sm:py-20 md:py-28 overflow-hidden bg-gradient-to-b from-[#EDFDF6] via-emerald-50/40 to-white selection:bg-[#0E7C66] selection:text-white">
      ...
      <div className="container relative mx-auto px-4 max-w-7xl">
        ...
        {/* ========================================================================= */}
        <div className="block md:hidden space-y-8 my-6">
          
          {/* Mobile Central Globe Network Display */}
          <div className="relative py-6 flex flex-col items-center justify-center">
            
            {/* Pulsing Atmosphere & Glow Ring */}
            <div className="relative h-48 w-48 xs:h-56 xs:w-56 sm:h-64 sm:w-64 rounded-full bg-gradient-to-b from-[#06382C] via-[#084738] to-[#03231B] shadow-[0_0_60px_rgba(14,124,102,0.4)] border-4 border-emerald-400/40 overflow-hidden flex items-center justify-center mx-auto">
              {/* Dot Grid */}
              ...
              <div className={`relative h-32 w-32 xs:h-36 xs:w-36 sm:h-44 sm:w-44 rounded-full bg-[url('https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=900&auto=format&fit=crop&q=80')] bg-cover shadow-xl border border-emerald-300/40 ${prefersReducedMotion ? "" : "animate-[spin_32s_linear_infinite]"}`}>
                <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-emerald-500/30 via-transparent to-cyan-400/40 mix-blend-overlay" />
              </div>
            ...
            {/* Surrounding Mobile Avatars (Neatly constrained) */}
            <div className="absolute -top-1 left-2 xs:left-6 sm:left-20 z-10">
            ...
            <div className="absolute top-4 right-2 xs:right-6 sm:right-20 z-10">
            ...
            <div className="absolute bottom-2 left-2 xs:left-6 sm:left-20 z-10">
            ...
            <div className="absolute bottom-2 right-2 xs:right-6 sm:right-20 z-10">
            ...
            <div className="mt-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-950/90 border border-emerald-500/40 text-emerald-300 text-[10px] xs:text-xs font-bold shadow-md">
              <span className="h-2 w-2 rounded-full bg-emerald-400 animate-ping" />
              <span>🔥 +10 000 Entrepreneurs connectés en direct</span>
            </div>
          </div>

          {/* Mobile Showcase Cards Grid (2x2 on tablet, 1-col on small phones) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            
            {/* Card 1: Fil ConnectUs */}
            <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3.5 xs:p-4 border border-emerald-100/90 shadow-md shadow-emerald-950/5 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&auto=format&fit=crop&q=80" alt="" className="h-8 w-8 rounded-lg object-cover ring-2 ring-[#0E7C66]" />
                  <div>
                    <div className="flex items-center gap-1">
                      <h4 className="font-bold text-xs text-slate-900">Amina Traoré</h4>
                      <CheckCircle2 className="h-3 w-3 text-[#0E7C66] fill-[#0E7C66] text-white" />
                    </div>
                    <p className="text-[10px] text-slate-500 font-medium">Entrepreneure • Abidjan</p>
                  </div>
                </div>
                <Badge className="bg-emerald-50 text-[#0E7C66] border-emerald-200 text-[9px] font-bold px-2 py-0.5">ConnectUs</Badge>
              </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 rounded-xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400&auto=format&fit=crop&q=80" alt="" className="h-16 xs:h-20 w-full object-cover" />
                <img src="https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&auto=format&fit=crop&q=80" alt="" className="h-16 xs:h-20 w-full object-cover" />
              </div>

              <div className="flex items-center justify-between text-[10px] text-slate-500 font-bold pt-1 border-t border-slate-100">
                <span className="flex items-center gap-1 text-emerald-700">
                  <Heart className="h-3 w-3 fill-emerald-600" /> 1,2 K
                </span>
                <span className="flex items-center gap-1">
                  <MessageCircle className="h-3 w-3" /> 245
                </span>
                <span className="flex items-center gap-1">
            ...
            {/* Card 2: Business Manager */}
            <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3.5 xs:p-4 border border-emerald-100/90 shadow-md shadow-emerald-950/5 space-y-3">
              <div className="flex items-center gap-2 text-[#0E7C66] font-bold text-xs font-space">
                <BarChart2 className="h-4 w-4 text-[#0E7C66]" />
                <span>Business Manager & Ads</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 text-xs font-medium text-slate-700">
                <div className="flex items-center gap-1.5 p-2 rounded-xl bg-slate-50">
                  ...
                  <span className="text-[11px] font-bold truncate">Audience</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-xl bg-slate-50">
                  <Megaphone className="h-3.5 w-3.5 text-amber-500 shrink-0" />
                  <span className="text-[11px] font-bold truncate">Pubs Ads</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-xl bg-slate-50">
                  <BarChart2 className="h-3.5 w-3.5 text-emerald-600 shrink-0" />
                  <span className="text-[11px] font-bold truncate">Analytique</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-xl bg-slate-50">
                  <Layers className="h-3.5 w-3.5 text-indigo-500 shrink-0" />
                  <span className="text-[11px] font-bold truncate">Pages</span>
                </div>
              </div>
            </div>

            {/* Card 3: Live Commerce */}
            <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3.5 xs:p-4 border border-emerald-100/90 shadow-md shadow-emerald-950/5 space-y-2.5">
              ...
              <Button size="sm" className="w-full rounded-full bg-[#0E7C66] hover:bg-[#0A6352] text-white font-bold text-xs gap-1.5 h-9">
                <ShoppingBag className="h-3.5 w-3.5" /> Acheter maintenant
              </Button>
            </div>
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-2xl p-3.5 xs:p-4 border border-emerald-100/90 shadow-md shadow-emerald-950/5 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-1.5 text-xs font-semibold">
                <div className="flex items-center gap-1.5 p-2 rounded-xl bg-emerald-50 text-emerald-800">
                  <Store className="h-3.5 w-3.5 shrink-0" />
                  <span className="text-[11px] truncate">E-commerce</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-xl bg-purple-50 text-purple-800">
                  <Megaphone className="h-3.5 w-3.5 shrink-0" />
                  <span className="text-[11px] truncate">Marketing</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-xl bg-blue-50 text-blue-800">
                  <Sparkles className="h-3.5 w-3.5 shrink-0" />
                  <span className="text-[11px] truncate">IA Business</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-xl bg-amber-50 text-amber-800">
                  <Users className="h-3.5 w-3.5 shrink-0" />
                  <span className="text-[11px] truncate">Business</span>
                </div>
              </div>
            </div>
